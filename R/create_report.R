...
# get path
path <-
    paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), ",outpath,")
...
```\n\n",
    "```{r map}
p_map <-
 readRDS('",paste0(ifelse(dir.exists('E:/PopDynCloud') == T, 'E:/PopDynCloud', 'C:/PopDynCloud'), path, '.rds'),"')
