...
meta$sub_name <- paste0(str_c(stringr::str_split(meta$folder, "_")[[1]] %>% str_sub(1,2), collapse = ""))
...
meta$sub_name <- paste0(str_c(stringr::str_split(meta$folder, "_")[[1]] %>% str_sub(1,2), collapse = ""), id)
