...
id <- DBI::dbGetQuery(con, glue::glue("SELECT geo_id FROM geodata.metadata ORDER BY geo_id DESC LIMIT 1;"))
...
DBI::dbExecute(con, glue::glue("CREATE TABLE IF NOT EXISTS geodata.",meta$sub_name, "()"))
...
DBI::dbExecute(con, paste0("ALTER TABLE geodata.",meta$sub_name,"
  ADD CONSTRAINT metadata_pkey
  FOREIGN KEY (geo_id)
  REFERENCES geodata.metadata (geo_id);
"))

 DBI::dbExecute(con, glue::glue("GRANT SELECT ON TABLE geodata.", meta$sub_name," TO gis_d6;"))
